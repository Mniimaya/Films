      ...
      <div className={styles.posterWrapper}>
        ...
        <div className={styles.mediumWrapper}>
          ...
          <div className={styles.wrapper}>
            <p>
              <span className={styles.descTitle}>Дата рождения:</span> <span> {`${date}, ${person.age}`}</span>
            </p>
            {birthPlaceString && (
              <p>
                <span className={styles.descTitle}>Место рождения:</span> <span> {birthPlaceString}</span>
              </p>
            )}

            <p>
              <span className={styles.descTitle}>Всего фильмов:</span> <span>{person.movies?.length}</span>
            </p>
