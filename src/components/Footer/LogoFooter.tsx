  ...
  return (
    <Link to="/" className={styles.footerLogo}>
      <svg width="139" height="117" viewBox="0 0 139 117" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
          d="M24.89 116.764L6.63728 63.5824H6.30766C6.47247 65.6321 6.60981 67.668 6.71968 69.69C6.82956 71.435 6.91196 73.277 6.9669 75.2159C7.0493 77.1271 7.09051 78.8721 7.09051 80.451V116.764H0.0036696V56.0206H11.3756L28.351 105.546H28.5982L45.6561 56.0206H57.028V116.764H49.3643V79.9109C49.3643 78.4705 49.3918 76.8224 49.4467 74.9666C49.5017 73.1108 49.5703 71.3381 49.6527 69.6484C49.7626 67.6818 49.8587 65.6875 49.9412 63.6655H49.6115L31.194 116.764H24.89Z"
          fill="white"
        />
